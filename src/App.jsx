  ...
  return (
    <section id="download" className="section download-section">
      <div className="container">
        ...
        <p style={{marginBottom: "2rem", maxWidth:"700px"}}>Download the BirdLens Vietnam APK now and join our community!</p>
        {/* Make sure birdlens.apk is in your public folder */}
        <a href="/birdlens.apk" download className="button">
          Download BirdLens APK (v0.1 Alpha)
        </a>
        <div className="download-instructions">
          ...
          <p>Target Users by End of Month 3: <strong>300-450 Users</strong>. Be one of them!</p>
        </div>
      </div>
    </section>
  );
